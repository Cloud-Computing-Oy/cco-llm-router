...
const PROVIDER_SECRET_RE = /^(?:ANTHROPIC_API_KEY|OPENAI_API_KEY|GROQ_API_KEY|OPENROUTER_API_KEY|DEEPINFRA_API_KEY|TOGETHER_API_KEY|DEEPSEEK_API_KEY|MOONSHOT_API_KEY|DASHSCOPE_API_KEY|ZAI_API_KEY|MINIMAX_API_KEY|MISTRAL_API_KEY|NVIDIA_API_KEY|COHERE_API_KEY|GOOGLE_GENERATIVE_AI_API_KEY(?:_PAID|_\d+)?|GOOGLE_GENAI_API_KEY|GEMINI_API_KEY)$/;
