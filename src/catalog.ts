...
export const MODEL_CATALOG: readonly CatalogEntry[] = [
  ...
  { provider: 'groq', model: 'qwen/qwen3.8-27b', family: 'qwen', capabilities: { tools: true, reasoning: true, structuredOutput: true, multimodal: false, contextTokens: 131_072 }, license: 'apache-2.0', lifecycle: 'current', pricing: 'free', source: 'Groq model catalog' },
  { provider: 'moonshot', model: 'kimi-k3', family: 'kimi', capabilities: { tools: true, reasoning: true, structuredOutput: true, multimodal: true, contextTokens: 1_000_000 }, license: 'vendor-terms', lifecycle: 'current', pricing: 'known', source: 'Moonshot API' },
  ...
  { provider: 'zai', model: 'glm-5.3', family: 'glm', capabilities: { tools: true, reasoning: true, structuredOutput: true, multimodal: true, contextTokens: 1_000_000 }, license: 'mit', lifecycle: 'current', pricing: 'known', source: 'Z.ai Models API and pricing page' },
