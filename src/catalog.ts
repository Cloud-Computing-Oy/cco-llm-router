...
export const MODEL_CATALOG: readonly CatalogEntry[] = [
  ...
  { provider: 'zai', model: 'glm-5.3-flash', family: 'glm', capabilities: { tools: true, reasoning: true, structuredOutput: true, multimodal: true, contextTokens: 1_000_000 }, license: 'mit', lifecycle: 'current', pricing: 'unknown', source: 'Z.ai Models API' },
