...
PRICING: dict[str, Price] = {
    ...
    "deepseek:deepseek-flash": {"input_per_m": 0.14, "output_per_m": 0.28},
    # Redirected identifier stays priced at Flash rates for budget safety.
    "deepseek:deepseek-v4-pro": {"input_per_m": 0.14, "output_per_m": 0.28},
