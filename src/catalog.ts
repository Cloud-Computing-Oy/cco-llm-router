...
export const MODEL_CATALOG: readonly CatalogEntry[] = [
  ...
  { provider: 'zai', model: 'glm-5', family: 'glm', capabilities: { tools: true, reasoning: true, structuredOutput: true, multimodal: false, contextTokens: 200_000 }, license: 'mit', lifecycle: 'current', pricing: 'unknown', source: 'Z.ai GLM-5 API' },
